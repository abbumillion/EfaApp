...
@Route(value = "h", layout = MainView.class)
...
public class AdminView extends Main implements HasComponents, HasStyle {
    ...
    public AdminView() {
        ...
        imageContainer.add(new AdminCardView("River between mountains",
                "https://images.unsplash.com/photo-1536048810607-3dc7f86981cb?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=375&q=80"));
        imageContainer.add(new AdminCardView("Milky way on mountains",
                "https://images.unsplash.com/photo-1515705576963-95cad62945b6?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80"));
        imageContainer.add(new AdminCardView("Mountain with fog",
        ...
        imageContainer.add(new AdminCardView("Mountain at night",
    ...
    private void constructUI() {
        ...
        sortBy.setItems("Job Type", "", "Oldest first");
